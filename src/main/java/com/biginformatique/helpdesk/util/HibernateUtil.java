    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:mysql://localhost:3307/helpdesk?allowPublicKeyRetrieval=true&useSSL=false&useTimezone=true&serverTimezone=GMT%2B1&useLegacyDatetimeCode=false&useUnicode=true&characterEncoding=utf8");
